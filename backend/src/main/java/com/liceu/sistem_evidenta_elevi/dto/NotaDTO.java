...
/**
 * DTO pentru primirea cererilor legate de note si returnarea raspunsurilor.
 * Aceasta clasa este utilizata pentru a transfera date despre note intre diferite straturi ale aplicatiei.
 */
